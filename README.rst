...
This fork includes enhanced features for AI integration and specialized search:

**🤖 Dify Integration**
  Native JSON API support for seamless integration with Dify AI development platform.

**📱 WeChat Search API**
  Dedicated API endpoint for searching WeChat public account articles.

See `API_USAGE.md`_ for detailed documentation and examples.

.. _API_USAGE.md: API_USAGE.md
...
**WeChat Search Engines:**
  - Primary WeChat search engine
  - Sogou WeChat search (backup)
...
3. **Test WeChat Search**::

     curl "http://localhost:8888/wechat_search?q=人工智能"
...
The instance includes optimized settings for API usage:
...
**Disabled Search Engines**::
   ...
   The following engines have been disabled for performance:
   quark, seznam, wolframalpha, crowdview, mojeek, mwmbl, 
   naver, bing (images/news/videos), bpb
